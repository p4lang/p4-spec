...
## Future: Integration with P4-SpecTec

P4-SpecTec is a P4 language mechanization framework. The P4-SpecTec project consists of (i) a formal, mechanized (machine-readable) specification of the P4 language, and (ii) a framework for executing the specification on P4 programs (for type checking and execution) and automatically generating a prose specification document from the formal specification. Together, the project aims to provide a more rigorous, precise, readable, and thoroughly tested specification of the P4 language.

As of March 2026, P4-SpecTec is *conditionally* adopted as the official specification authoring toolchain by the P4 Language Design Working Group. Under adoption, updates to the P4 specification will be made to the mechanized specification, and the prose specification document will be automatically generated. Also, the updated specification will be tested against the P4 tests under the `p4c` compiler repository.

The adoption is conditioned on documentation of the framework, improving user experience, integrating the framework with the current P4 specification maintenance workflow, and having a transitional period for the P4 community to adapt to the new framework and the specification document generated from it.

The project repository can be found [here](https://github.com/kaist-plrg/p4-spectec). The auto-generated specification document can be found [here](https://kaist-plrg.github.io/p4-spectec/p4/P4-16-spec-release.html).
