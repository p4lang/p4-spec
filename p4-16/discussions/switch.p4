...
control process_replication(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action outer_replica_from_rid(bit<16> bd, bit<14> tunnel_index, bit<5> tunnel_type) {
    ...
    action outer_replica_from_rid_with_nexthop(bit<16> bd, bit<16> nexthop_index, bit<14> tunnel_index, bit<5> tunnel_type) {
        meta.egress_metadata.bd = bd;
        meta.multicast_metadata.replica = 1w1;
        meta.multicast_metadata.inner_replica = 1w0;
    ...
    action inner_replica_from_rid(bit<16> bd, bit<14> tunnel_index, bit<5> tunnel_type) {
        meta.egress_metadata.bd = bd;
        meta.multicast_metadata.replica = 1w1;
    ...
    action inner_replica_from_rid_with_nexthop(bit<16> bd, bit<16> nexthop_index, bit<14> tunnel_index, bit<5> tunnel_type) {
        meta.egress_metadata.bd = bd;
        meta.multicast_metadata.replica = 1w1;
        meta.multicast_metadata.inner_replica = 1w1;
        meta.egress_metadata.routed = meta.l3_metadata.routed;
...
control process_rewrite(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action set_l3_rewrite(bit<16> bd, bit<8> mtu_index, bit<9> smac_idx, bit<48> dmac) {
    ...
    action set_l3_rewrite_with_tunnel(bit<16> bd, bit<9> smac_idx, bit<48> dmac, bit<14> tunnel_index, bit<5> tunnel_type) {
        meta.egress_metadata.routed = 1w1;
        meta.egress_metadata.smac_idx = smac_idx;
        meta.egress_metadata.mac_da = dmac;
        meta.egress_metadata.bd = bd;
    ...
    action set_mpls_swap_push_rewrite_l3(bit<16> bd, bit<9> smac_idx, bit<48> dmac, bit<20> label, bit<14> tunnel_index, bit<4> header_count) {
        meta.egress_metadata.routed = meta.l3_metadata.routed;
        meta.egress_metadata.bd = bd;
        hdr.mpls[0].label = label;
        meta.egress_metadata.smac_idx = smac_idx;
    ...
    action set_mpls_push_rewrite_l3(bit<16> bd, bit<9> smac_idx, bit<48> dmac, bit<14> tunnel_index, bit<4> header_count) {
        meta.egress_metadata.routed = meta.l3_metadata.routed;
        meta.egress_metadata.bd = bd;
        meta.egress_metadata.smac_idx = smac_idx;
        meta.egress_metadata.mac_da = dmac;
...
control process_mac_rewrite(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action rewrite_ipv4_unicast_mac(bit<48> smac) {
        hdr.ethernet.srcAddr = smac;
        hdr.ethernet.dstAddr = meta.egress_metadata.mac_da;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    action rewrite_ipv4_multicast_mac(bit<48> smac) {
        hdr.ethernet.srcAddr = smac;
        hdr.ethernet.dstAddr[47:23] = 48w0x1005e000000[47:23];
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    action rewrite_ipv6_unicast_mac(bit<48> smac) {
        hdr.ethernet.srcAddr = smac;
        hdr.ethernet.dstAddr = meta.egress_metadata.mac_da;
        hdr.ipv6.hopLimit = hdr.ipv6.hopLimit + 8w255;
    }
    action rewrite_ipv6_multicast_mac(bit<48> smac) {
        hdr.ethernet.srcAddr = smac;
        hdr.ethernet.dstAddr[47:32] = 48w0x333300000000[47:32];
        hdr.ipv6.hopLimit = hdr.ipv6.hopLimit + 8w255;
    }
    action rewrite_mpls_mac(bit<48> smac) {
        hdr.ethernet.srcAddr = smac;
        hdr.ethernet.dstAddr = meta.egress_metadata.mac_da;
...
control process_tunnel_encap(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action inner_non_ip_rewrite() {
        meta.egress_metadata.payload_length = standard_metadata.packet_length + 16w65522;
    }
    ...
    action f_insert_ipv4_header(in bit<8> proto) {
    ...
    action f_insert_ipv6_header(in bit<8> proto) {
    ...
    action set_tunnel_rewrite_details(bit<16> outer_bd, bit<8> mtu_index, bit<9> smac_idx, bit<14> dmac_idx, bit<9> sip_index, bit<14> dip_index) {
    ...
    action set_mpls_rewrite_push2(bit<20> label1, bit<3> exp1, bit<8> ttl1, bit<20> label2, bit<3> exp2, bit<8> ttl2, bit<9> smac_idx, bit<14> dmac_idx) {
        hdr.mpls[0].label = label1;
        hdr.mpls[0].exp = exp1;
        hdr.mpls[0].ttl = ttl1;
    ...
    action set_mpls_rewrite_push3(bit<20> label1, bit<3> exp1, bit<8> ttl1, bit<20> label2, bit<3> exp2, bit<8> ttl2, bit<20> label3, bit<3> exp3, bit<8> ttl3, bit<9> smac_idx, bit<14> dmac_idx) {
        hdr.mpls[0].label = label1;
        hdr.mpls[0].exp = exp1;
        hdr.mpls[0].ttl = ttl1;
        hdr.mpls[0].bos = 1w0x0;
...
control process_egress_filter(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action set_egress_ifindex(bit<16> egress_ifindex) {
...
control process_egress_acl(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action egress_mirror(in bit<16> session_id) {
    ...
    action egress_mirror_drop(bit<16> session_id) {
        egress_mirror(session_id);
        standard_metadata.drop = 1;
    }
    action egress_copy_to_cpu(in bit<16> reason_code) {
    ...
    action egress_redirect_to_cpu(bit<16> reason_code) {
...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    process_int_insertion() process_int_insertion_0;
    process_mac_rewrite() process_mac_rewrite_0;
    process_tunnel_encap() process_tunnel_encap_0;
    process_int_outer_encap() process_int_outer_encap_0;
    ...
    apply {
        if (meta.intrinsic_metadata.deflection_flag == 1w0 && meta.egress_metadata.bypass == 1w0) {
            if (standard_metadata.instance_type != 8w0 && standard_metadata.instance_type != 8w5) {
                mirror.apply();
            }
            else {
...
control process_ingress_port_mapping(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    action set_ifindex(bit<16> ifindex, bit<15> if_label, bit<2> port_type) {
...
control process_storm_control(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    Meter(32w1024, CounterType.Bytes) storm_control_meter;
    action nop() {
    }
    action set_storm_control_meter(bit<8> meter_idx) {
        meta.security_metadata.storm_control_color = storm_control_meter.meter((bit<32>)meter_idx);
    }
    table storm_control() {
        actions = {
            nop;
...
control process_port_vlan_mapping(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    action set_bd(bit<16> bd, bit<12> vrf, bit<10> rmac_group, bit<1> ipv4_unicast_enabled, bit<1> ipv6_unicast_enabled, bit<2> ipv4_urpf_mode, bit<2> ipv6_urpf_mode, bit<1> igmp_snooping_enabled, bit<1> mld_snooping_enabled, bit<16> bd_label, bit<10> stp_group, bit<16> stats_idx, bit<1> learning_enabled) {
    ...
    table port_vlan_mapping() {
        ...
        size = 4096;
        implementation = ActionProfile(32w1024);
    }
...
control process_mpls(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action terminate_ipv4_over_mpls(bit<12> vrf, bit<5> tunnel_type) {
        meta.tunnel_metadata.tunnel_terminate = 1w1;
        meta.tunnel_metadata.ingress_tunnel_type = tunnel_type;
        meta.l3_metadata.vrf = vrf;
        meta.l3_metadata.lkp_ip_type = 2w1;
    ...
    action terminate_ipv6_over_mpls(bit<12> vrf, bit<5> tunnel_type) {
        meta.tunnel_metadata.tunnel_terminate = 1w1;
        meta.tunnel_metadata.ingress_tunnel_type = tunnel_type;
        meta.l3_metadata.vrf = vrf;
        meta.l3_metadata.lkp_ip_type = 2w2;
...
control process_tunnel(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action terminate_tunnel_inner_ethernet_ipv4(bit<16> bd, bit<12> vrf, bit<10> rmac_group, bit<16> bd_label, bit<1> ipv4_unicast_enabled, bit<2> ipv4_urpf_mode, bit<1> igmp_snooping_enabled, bit<16> stats_idx) {
        meta.tunnel_metadata.tunnel_terminate = 1w1;
        meta.ingress_metadata.bd = bd;
        meta.l3_metadata.vrf = vrf;
    ...
    action terminate_tunnel_inner_ipv4(bit<12> vrf, bit<10> rmac_group, bit<2> ipv4_urpf_mode, bit<1> ipv4_unicast_enabled) {
        meta.tunnel_metadata.tunnel_terminate = 1w1;
        meta.l3_metadata.vrf = vrf;
        meta.qos_metadata.outer_dscp = meta.l3_metadata.lkp_ip_tc;
        meta.l3_metadata.lkp_ip_type = 2w1;
    ...
    action terminate_tunnel_inner_ethernet_ipv6(bit<16> bd, bit<12> vrf, bit<10> rmac_group, bit<16> bd_label, bit<1> ipv6_unicast_enabled, bit<2> ipv6_urpf_mode, bit<1> mld_snooping_enabled, bit<16> stats_idx) {
        meta.tunnel_metadata.tunnel_terminate = 1w1;
        meta.ingress_metadata.bd = bd;
        meta.l3_metadata.vrf = vrf;
        meta.qos_metadata.outer_dscp = meta.l3_metadata.lkp_ip_tc;
    ...
    action terminate_tunnel_inner_ipv6(bit<12> vrf, bit<10> rmac_group, bit<1> ipv6_unicast_enabled, bit<2> ipv6_urpf_mode) {
        meta.tunnel_metadata.tunnel_terminate = 1w1;
        meta.l3_metadata.vrf = vrf;
        meta.qos_metadata.outer_dscp = meta.l3_metadata.lkp_ip_tc;
        meta.l3_metadata.lkp_ip_type = 2w2;
    ...
    process_ipv4_vtep() process_ipv4_vtep_0;
    process_ipv6_vtep() process_ipv6_vtep_0;
    process_mpls() process_mpls_0;
    apply {
...
control process_mac_acl(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action acl_log(bit<32> acl_stats_index) {
        meta.ingress_metadata.enable_dod = 1w0;
        meta.acl_metadata.acl_stats_index = acl_stats_index;
    }
    action acl_deny(bit<32> acl_stats_index) {
        meta.acl_metadata.acl_deny = 1w1;
        meta.ingress_metadata.enable_dod = 1w0;
        meta.acl_metadata.acl_stats_index = acl_stats_index;
    }
    action acl_permit(bit<32> acl_stats_index) {
        meta.ingress_metadata.enable_dod = 1w0;
        meta.acl_metadata.acl_stats_index = acl_stats_index;
    }
    action acl_mirror(bit<16> session_id, bit<32> acl_stats_index) {
        meta.i2e_metadata.mirror_session_id = session_id;
        meta.i2e_metadata.ingress_tstamp = meta.intrinsic_metadata.ingress_global_tstamp;
        meta.ingress_metadata.enable_dod = 1w0;
...
control process_ip_acl(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action acl_redirect_nexthop(bit<16> nexthop_index, bit<32> acl_stats_index) {
    ...
    action acl_redirect_ecmp(bit<16> ecmp_index, bit<32> acl_stats_index) {
        meta.acl_metadata.acl_redirect = 1w1;
...
control process_qos(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action apply_cos_marking(bit<3> cos) {
        meta.qos_metadata.marked_cos = cos;
    }
    action apply_dscp_marking(bit<8> dscp) {
        meta.qos_metadata.marked_dscp = dscp;
    }
    action apply_tc_marking(bit<3> tc) {
...
control process_ipv4_racl(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action racl_log(bit<32> acl_stats_index) {
        meta.acl_metadata.acl_stats_index = acl_stats_index;
    }
    action racl_deny(bit<32> acl_stats_index) {
        meta.acl_metadata.racl_deny = 1w1;
        meta.acl_metadata.acl_stats_index = acl_stats_index;
    }
    action racl_permit(bit<32> acl_stats_index) {
        meta.acl_metadata.acl_stats_index = acl_stats_index;
    }
    action racl_redirect_nexthop(bit<16> nexthop_index, bit<32> acl_stats_index) {
        meta.acl_metadata.racl_redirect = 1w1;
        meta.acl_metadata.racl_nexthop = nexthop_index;
        meta.acl_metadata.racl_nexthop_type = 1w0;
        meta.acl_metadata.acl_stats_index = acl_stats_index;
    }
    action racl_redirect_ecmp(bit<16> ecmp_index, bit<32> acl_stats_index) {
        meta.acl_metadata.racl_redirect = 1w1;
...
control process_hashes(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    action compute_lkp_ipv4_hash() {
        meta.hash_metadata.hash1 = hash(HashAlgorithm.crc16, (bit<16>)0, { meta.ipv4_metadata.lkp_ipv4_sa, meta.ipv4_metadata.lkp_ipv4_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<16>)65536);
        meta.hash_metadata.hash2 = hash(HashAlgorithm.crc16, (bit<16>)0, { meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.ipv4_metadata.lkp_ipv4_sa, meta.ipv4_metadata.lkp_ipv4_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<16>)65536);
    }
    action compute_lkp_ipv6_hash() {
        meta.hash_metadata.hash1 = hash(HashAlgorithm.crc16, (bit<16>)0, { meta.ipv6_metadata.lkp_ipv6_sa, meta.ipv6_metadata.lkp_ipv6_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<16>)65536);
        meta.hash_metadata.hash2 = hash(HashAlgorithm.crc16, (bit<16>)0, { meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.ipv6_metadata.lkp_ipv6_sa, meta.ipv6_metadata.lkp_ipv6_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<16>)65536);
    }
    action compute_lkp_non_ip_hash() {
        meta.hash_metadata.hash2 = hash(HashAlgorithm.crc16, (bit<16>)0, { meta.ingress_metadata.ifindex, meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.l2_metadata.lkp_mac_type }, (bit<16>)65536);
    }
...
control process_ingress_bd_stats(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    Counter(32w1024, CounterType.Both) ingress_bd_stats;
...
control process_ingress_acl_stats(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    Counter(32w1024, CounterType.Both) acl_stats;
...
control process_nexthop(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    table ecmp_group() {
        ...
        size = 1024;
        implementation = ActionSelector(HashAlgorithm.random, 32w1024, 32w10);
    }
...
control process_lag(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    table lag_group() {
        ...
        size = 1024;
        implementation = ActionSelector(HashAlgorithm.random, 32w1024, 32w8);
    }
...
control process_mac_learning(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action generate_learn_notify() {
        digest((bit<32>)1024, { meta.ingress_metadata.bd, meta.l2_metadata.lkp_mac_sa, meta.ingress_metadata.ifindex });
    }
    table learn_notify() {
        actions = {
            nop;
...
control process_system_acl(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    Counter(32w1024, CounterType.Packets) drop_stats;
    ...
    action copy_to_cpu(in bit<16> reason_code) {
        meta.fabric_metadata.reason_code = reason_code;
    ...
    action redirect_to_cpu(bit<16> reason_code) {
    ...
    action negative_mirror(bit<8> session_id) {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    process_ingress_port_mapping() process_ingress_port_mapping_0;
    process_validate_outer_header() process_validate_outer_header_0;
    ...
    process_int_endpoint() process_int_endpoint_0;
    process_tunnel() process_tunnel_0;
    ...
    process_ingress_fabric() process_ingress_fabric_0;
    process_hashes() process_hashes_0;
    process_ingress_bd_stats() process_ingress_bd_stats_0;
    process_ingress_acl_stats() process_ingress_acl_stats_0;
    process_fwd_results() process_fwd_results_0;
    process_nexthop() process_nexthop_0;
    process_multicast_flooding() process_multicast_flooding_0;
...
control verifyChecksum(in headers hdr, inout standard_metadata_t standard_metadata) {
