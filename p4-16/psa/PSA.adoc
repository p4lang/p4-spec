...
<<packet-path-abbreviations>> defines the meanings of the
...
the same as shown in <<packet-path-abbreviations>>, but have been
...
[source,p4]
----
include::psa.p4[tag=Type_defns]
include::psa.p4[tag=Type_defns2]
----
...
[source,p4]
----
include::psa.p4[tag=Metadata_types]
----
...
[source,p4]
----
include::psa.p4[tag=Match_kinds]
----
...
[source,p4]
----
include::psa.p4[tag=Programmable_blocks]
----
...
[source,p4]
----
include::psa.p4[tag=Action_send_to_port]
----
...
[source,p4]
----
include::psa.p4[tag=Action_multicast]
----
...
[source,p4]
----
include::psa.p4[tag=Action_ingress_drop]
----
...
[source,p4]
----
include::psa.p4[tag=Metadata_egress_output]
...
[source,p4]
----
include::psa.p4[tag=Action_egress_drop]
----
...
[source,p4]
----
include::examples/psa-example-clone-to-port.p4[tag=Clone_Example_Part1]
include::examples/psa-example-clone-to-port.p4[tag=Clone_Example_Part2]
include::examples/psa-example-clone-to-port.p4[tag=Clone_Example_Part3]
----
...
* In a multi-pipeline device, there are effectively multiple
  ...
  See <<appendix-multi-pipeline-psa-devices>>.
...
[source,p4]
----
include::psa.p4[tag=enum_PSA_IdleTimeout_t]
----
...
[source,p4]
----
include::examples/psa-example-counters.p4[tag=Package_Instantiation_Example]
----
...
[source,p4]
----
include::psa.p4[tag=Hash_algorithms]
----
...
[source,p4]
----
include::psa.p4[tag=Hash_extern]
----
...
[source,p4]
----
include::psa.p4[tag=Checksum_extern]
----
...
and <<appendix-internetchecksum-implementation>> for details.

[source,p4]
----
include::psa.p4[tag=InternetChecksum_extern]
----
...
[source,p4]
----
include::examples/psa-example-parser-checksum.p4[tag=Parse_Error_Example]
----
...
[source,p4]
----
include::examples/psa-example-parser-checksum.p4[tag=Compute_New_IPv4_Checksum_Example]
----
...
[source,p4]
----
include::examples/psa-example-incremental-checksum.p4[tag=Incremental_Checksum_Table]
----
...
[source,p4]
----
include::examples/psa-example-incremental-checksum.p4[tag=Incremental_Checksum_Example]
----
...
[source,p4]
----
include::psa.p4[tag=CounterType_defn]
----
...
[source,p4]
----
include::psa.p4[tag=Counter_extern]
----

See <<appendix-counter-implementation>> for pseudocode of an
...
[source,p4]
----
include::psa.p4[tag=DirectCounter_extern]
----
...
[source,p4]
----
include::examples/psa-example-counters.p4[tag=Counter_Example_Part1]

include::examples/psa-example-counters.p4[tag=Counter_Example_Part2]
----
...
[source,p4]
----
include::psa.p4[tag=MeterType_defn]
----
...
[source,p4]
----
include::psa.p4[tag=MeterColor_defn]
----
...
[source,p4]
----
include::psa.p4[tag=Meter_extern]
----
...
[source,p4]
----
include::psa.p4[tag=DirectMeter_extern]
----
...
[source,p4]
----
include::psa.p4[tag=Register_extern]
----
...
[source,p4]
----
include::examples/psa-example-register2.p4[tag=Register_Example2_Part1]

include::examples/psa-example-register2.p4[tag=Register_Example2_Part2]
----
...
[source,p4]
----
include::psa.p4[tag=Random_extern]
----
...
[source,p4]
----
include::psa.p4[tag=ActionProfile_extern]
----
...
a table entry or default action, a P4 program that requires equivalent
behavior in multiple contexts must define separate actions for each context.
...
observe.  See <<appendix-empty-action-selector-groups>>.
...
[source,p4]
----
include::psa.p4[tag=ActionSelector_extern]
----
...
[source,p4]
----
include::psa.p4[tag=Digest_extern]
----
...
[source,p4]
----
include::examples/psa-example-digest.p4[tag=Digest_Example_Part1]

include::examples/psa-example-digest.p4[tag=Digest_Example_Part2]

include::examples/psa-example-digest.p4[tag=Digest_Example_Part3]
----
...
== Implementation of the InternetChecksum extern
...
== Example implementation of Counter extern
...
== Supporting empty action selector groups
