...
\ifpdf
    \pdfinfo {
        ...
        /Title    (The P4 Language Specification, v 1.0.2)
        /Keywords (P4)
        /Subject  ()
        /Creator  (TeX)
        /Producer (PDFLaTeX)
...
\vspace{3mm}
\centerline{\sffamily\Large Version 1.0.2}
\vspace{3mm}
\centerline{\sffamily\large March 3, 2015}
\vspace{8mm}
...
layout_declaration ::= @\textbf{layout}@ : header_type_name ;
...
\begin{lstlisting}[frame=single,backgroundcolor=\color{bnfgreen},escapechar=\@]
register_reference ::=
    register_name "@\textbf{[}@" const_value "@\textbf{]}@" [@\textbf{.}@field_name]
\end{lstlisting}
%%endbnf
...
\item
A reference to a register cell whose current value is used.
\end{itemize}
